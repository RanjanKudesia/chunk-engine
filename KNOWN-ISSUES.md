> ⚠️ **SUPERSEDED — do not edit this file.**
> The canonical tracker is now [`../TECH_DEBT.md`](../TECH_DEBT.md) at the
> workspace root (engine + website + benchmark debt in one place).
> Kept so the repo is self-describing; update the root file instead.
